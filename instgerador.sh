...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/phreaker56/Generador_Gen_VPS-MX/master/Control-IP")
  [[ $(echo $permited|grep "${IP}") = "" ]] && {
  echo -e "\n\n\n\033[1;31m====================================================="
  echo -e "\033[1;31m       ¡LA IP $(wget -qO- ipv4.icanhazip.com) NO ESTA AUTORIZADA!"
  echo -e "\033[1;31m                CONTACTE A @Phreaker5"
  echo -e "\033[1;31m=====================================================\n\n\n"
  [[ -d /etc/SCRIPT ]] && rm -rf /etc/SCRIPT
  exit 1
  } || {
  ### INTALAR VERCION DE SCRIPT
  v1=$(curl -sSL "https://raw.githubusercontent.com/phreaker56/Generador_Gen_VPS-MX/master/Vercion")
...
wget https://raw.githubusercontent.com/phreaker56/Generador_Gen_VPS-MX/master/gerador/gerar.sh &>/dev/null
